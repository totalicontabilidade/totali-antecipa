...
const TABELAS_SE = {
  ...
  receitas: [
    ...
    { id: 'difal',            cod: '2445', nome: 'Difer.de Alíquota',
      ...
      formula: 'K × alíq. interna − K × alíq. interestadual (sem MVA)',
      mva: 'nenhum', acrescimos: true, base: 'EC 87/2015; RICMS/SE art. 480-L' },
  ...
  regrasNcm: [
    ...
    { id: "rac-pet", prioridade: 15, ncm: "2309", match: "inicia", simplesTambem: true, descricao: "Ração tipo pet para animais domésticos (CEST 22.001.00) — ST com encerramento, alíquota 19% + FECOEP 2 pontos", regime: "antecip_encer", encerra: true, mva: { 4: 77.42, 7: 71.87, 12: 62.63, interna: 46 }, aliq: 19, fecoep: 2, confirmar: false, fundamento: "RICMS/SE art. 681, XIV e Anexo IX, Tabela I, item 43; Protocolo ICMS 26/2004 — MVA e FECOEP da planilha oficial de ST de SE (v0019)" },
